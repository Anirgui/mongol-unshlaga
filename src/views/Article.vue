...
<template>
  <div class="reader">
    ...
    <main v-if="article" class="article">
    ...
    <main v-else class="not-found">
      ...
      <p>Энэ нийтлэл устсан эсвэл байхгүй байна.</p>
...
.mongol-reader {
  ...
  /* Гар утсан дээр swipe-ийг зөөлөн болгоно */
